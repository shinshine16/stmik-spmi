...
@section('sidebar_active')
  <input type="hidden" class="for-active-sidebar" value="sidebar_pejabat">
@endsection

@section('content')
<div class="container">
    <div class="page-header">
        <h1 class="page-header__title" id="title_page">Pejabat Yang Mengesahkan</h1>
    </div>
        ...
        <div class="page-tools__breadcrumbs">
            ...
            <svg class="icon-icon-keyboard-right breadcrumbs__arrow">
              <use xlink:href="#icon-keyboard-right"></use>
                        ...
                        <li class="breadcrumbs__item active"><span class="breadcrumbs__link">Pejabat</span>
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <form action="{{ route('admin_master_pejabat_kelola') }}" method="post" id="kelola">
      @csrf
                ...
                <thead class="table__header">
                  ...
                  <svg class="icon-icon-checked">
                    <use xlink:href="#icon-checked"></use>
                        ...
                        <th class="table__th-sort" width="80%"><span class="align-middle">Nama Pejabat</span><span class="sort sort--down"></span>
                        </th>
                          ...
                          <div class="row row--md">
                              <div class="col-12 form-group form-group--lg">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input class="input" type="text" id="nama_pejabat" value="" required>
                                  </div>
                              </div>
                          </div>
                      </form>
