...
@section('sidebar_active')
  <input type="hidden" class="for-active-sidebar" value="sidebar_menu">
@endsection

@section('content')
<div class="container">
    <div class="page-header">
        <h1 class="page-header__title" id="title_page">Menu</h1>
    </div>
        ...
        <div class="page-tools__breadcrumbs">
            ...
            <svg class="icon-icon-keyboard-right breadcrumbs__arrow">
              <use xlink:href="#icon-keyboard-right"></use>
                        ...
                        <li class="breadcrumbs__item active"><span class="breadcrumbs__link">Menu</span>
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <form action="{{ route('admin_master_menu_kelola') }}" method="post" id="kelola">
      @csrf
                ...
                <thead class="table__header">
                  ...
                  <svg class="icon-icon-checked">
                    <use xlink:href="#icon-checked"></use>
                        ...
                        <th class="table__th-sort" width="40%"><span class="align-middle">Nama Menu</span><span class="sort sort--down"></span>
                        </th>
                        <th class="table__th-sort"  width="25%"><span class="align-middle">Publish</span><span class="sort sort--down"></span>
                        </th>
                        <th class="table__actions" width="20%"></th>
                    </tr>
                </thead>
                <tbody>
                            ...
                            <div class="col-6 col-md-6 form-group form-group--lg">
                              ...
                              <div class="col-12 form-group form-group--lg">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input class="input" type="text" id="nama_menu" value="" required>
                                  </div>
                              </div>
                          </div>
                      </form>
