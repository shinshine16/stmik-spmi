                    ...
                    <div class="widget__wrapper">
                        <div class="widget__row">
                            <div class="widget__left">
                                <h3 class="widget__title">Dokumen</h3>
                                <div class="widget__status-title text-grey">Total dokumen tercatat</div>
                            ...
                            <div class="widget__chart">
                                <div class="widget__chart-inner">
                                    <div class="widget__chart-percentage">{{ $total_dokumen }}<small></small>
                                    </div>
                                    <div class="widget__chart-caption">Dokumen</div>
                                </div>
                                <div class="widget__chart-canvas js-progress-circle" data-value="0.100" data-color="#eff4f8"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-xl-4 d-flex">
                <div class="widget">
                    <div class="widget__wrapper">
                        <div class="widget__row">
                            <div class="widget__left">
                                <h3 class="widget__title">File</h3>
                                <div class="widget__status-title text-grey">File terupload</div>
                                <div class="widget__trade">
                                    {{-- <span class="widget__trade-count">1000</span><span class="trade-icon trade-icon--down">
                            ...
                            <div class="widget__chart">
                                <div class="widget__chart-inner">
                                    <div class="widget__chart-percentage">{{ $total_file }}<small></small>
                                    </div>
                                    <div class="widget__chart-caption">File</div>
                                </div>
                                <div class="widget__chart-canvas js-progress-circle" data-value="0.75" data-color="#eff4f8"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6 col-xl-4 d-flex">
                <div class="widget">
                    <div class="widget__wrapper">
                        <div class="widget__row">
                            <div class="widget__left">
                                <h3 class="widget__title">Download</h3>
                                <div class="widget__status-title text-grey">Total file terdownload</div>
                                <div class="widget__trade">
                                    {{-- <span class="widget__trade-count">$500</span><span class="trade-icon trade-icon--up">
                                    <svg class="icon-icon-trade-up">
                                      <use xlink:href="#icon-trade-up"></use>
                            ...
                            <div class="widget__chart">
                                <div class="widget__chart-inner">
                                    <div class="widget__chart-percentage">{{ $total_download }}<small></small>
                                    </div>
                                    <div class="widget__chart-caption">Download</div>
                                </div>
                                <div class="widget__chart-canvas js-progress-circle" data-value="0.8" data-color="#eff4f8"></div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card__body">
                                <div class="card__credit-card">
                                    <div class="credit-card">
                                        <img class="credit-card__image" src="img/content/credit-card%403x.png" alt="#" />
                                        ...
                                        <div class="card__credits-items row">
                                            <div class="card__credits-item col-auto">
                                                <div class="credit-card credit-card--light">
                                                    <img class="credit-card__image" src="img/content/credit-visa%403x.png" alt="#" />
                                                    <div class="credit-card__content">
                                                        <input class="credit-card__number" type="text" value="0123   4567   8910   1112" readonly="readonly" />
                                                        <div class="credit-card__name">Mark Anderson</div>
                                                        <div class="credit-card__date">12/31</div>
                                            ...
                                            <div class="card__credits-item col-auto">
                                                <div class="credit-card credit-card--light">
                                                    <img class="credit-card__image" src="img/content/credit-mastercard%403x.png" alt="#" />
                                                    <div class="credit-card__content">
                                                        <input class="credit-card__number" type="text" value="0123   4567   8910   1112" readonly="readonly" />
                                                        <div class="credit-card__name">Mark Anderson</div>
                                                        <div class="credit-card__date">12/31</div>
