...
$remove = substr($root, strpos($root, "assets") + 0);
$root = str_replace($remove, "", $root);
// var_dump($root.'uploads/ckfinder/userfiles/');die();
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => $root.'storage/uploads/ckfinder/userfiles/',
    'root'         => '../../../../../storage/uploads/ckfinder/userfiles/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
